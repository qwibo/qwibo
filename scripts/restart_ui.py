...
#!/usr/bin/env python3
"""Termina le istanze UI/worker di Qwibo e ne avvia una sola."""
...
def main() -> int:
    ...
    from qwibo.ui.process_guard import (
        clear_package_cache,
    ...
    print("Pulizia istanze Qwibo precedenti...")
