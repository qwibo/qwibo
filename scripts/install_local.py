...
#!/usr/bin/env python3
"""Installazione locale Qwibo (Windows/Linux/macOS). Nessuno script PowerShell."""
...
def main() -> int:
    print("=== Qwibo - installazione locale ===\n")
