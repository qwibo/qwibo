...
#!/usr/bin/env python3
"""
Monitor benchmark Qwibo — tabella live + report finale.
...
from qwibo.config import TranscribeConfig, output_dir  # noqa: E402
from qwibo.extract import get_duration_sec  # noqa: E402
from qwibo.jobs import (  # noqa: E402
    STATUS_COMPLETED,
    STATUS_FAILED,
    STATUS_RUNNING,
    JobRecord,
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Monitor benchmark Qwibo")
    parser.add_argument(
        "--watch",
        action="store_true",
