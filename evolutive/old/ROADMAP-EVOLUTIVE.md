...
**Futuro (v1+, remoto):**
- Diarizzazione (chi parla) — evolutiva remota; vedi [EVOLUTIVE-REMOTE.md](./EVOLUTIVE-REMOTE.md) e [ANALISI-DIARIZZAZIONE-SPEAKER.md](./ANALISI-DIARIZZAZIONE-SPEAKER.md)
...
| 4.2 | Diarizzazione (evolutiva remota — vedi EVOLUTIVE-REMOTE.md) |
...
| Data | Modifica |
|------|----------|
| 2026-07-01 | Diarizzazione spostata in EVOLUTIVE-REMOTE (non prioritaria) |
