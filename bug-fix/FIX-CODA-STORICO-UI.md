...
> **Correlato:** `TRACCIAMENTO-BUG.md`, `microevolutive/README.md`  
...
| Path | Ruolo |
|------|--------|
| `src/qwibo/jobs.py` | SQLite, enqueue, `is_source_in_active_queue` |
| `src/qwibo/ui/server.py` | `/enqueue`, partials, sidebar `load_index()` |
| `src/qwibo/ui/templates/index.html` | UI monolitica |
| `src/qwibo/ui/templates/partials/queue.html` | Solo coda attiva |
| `src/qwibo/worker.py` | Worker FIFO |
