...
> **Data**: 2026-07-02 · **Stato**: ✅ **implementato** (v1 codice, con `PLAN_MULTILANG_ASR.md`)  
...
| Pezzo | File | Note |
|-------|------|------|
| Prompt riassunto | `src/qwibo/summarize_providers/prompt.py` | Solo italiano, regole anti-meta-frasi |
...
```
src/qwibo/summarize_providers/prompt.py   ← cuore modifica
src/qwibo/summarize_providers/*.py      ← pass language
src/qwibo/jobs.py                       ← summary_language
src/qwibo/ui/templates/index.html
src/qwibo/ui/templates/settings_summary.html
src/qwibo/summary_config.py
```
