...
def _env(name: str, *, legacy: str | None = None) -> str | None:
    """Legge variabile d'ambiente; opzionale fallback legacy (migrazione Qwibo)."""
    import os
...
def data_dir() -> Path:
    ...
    """Cartella dati (input/output). In Docker: QWIBO_DATA=/data."""

    import os



    env = _env("QWIBO_DATA", legacy="QWIBO_DATA")
...
class TranscribeConfig:
    ...
    language: str = "it"  # Lingua parlata attesa (it, en, fr, es, de)
