...
from qwibo.config import DEFAULT_MODEL, data_dir
...
class JobRecord:
    ...
    asr_language: str = DEFAULT_LANGUAGE
...
def _init_schema(conn: sqlite3.Connection) -> None:
    conn.execute(
        ...
        CREATE TABLE IF NOT EXISTS jobs (
            ...
            asr_language TEXT DEFAULT 'it',
            summary_language TEXT DEFAULT 'it'
        )
        """
    )
